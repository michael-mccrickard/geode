...
context.font = props.fontSize + " " + props.fontName

//context.font = "16px Koulen"
console.log("string to context.font is " + context.font)
console.log("text is " + props.textVal)

        var spanWidth2 = (context.measureText(props.textVal).width)

console.log("measured width with " + props.fontName + " is " + spanWidth2)
